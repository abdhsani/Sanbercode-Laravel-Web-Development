...
<body>
    ...
    for ($i = 0; $i < count($numbers); $i++) {
        echo "<br>";
        echo "Array " . $numbers[$i] . " sisa baginya adalah: " . $numbers[$i] % 5;
        echo "<br>";
    }
    ...
    $assoc = [
        'id' => ['001', '002', '003', '004'],
        'name' => ['Keyboard Logitek', 'Keyboard MSI', 'Mouse Genius', 'Mouse Jerry'],
        'price' => [60000, 300000, 50000, 30000],
        'description' => ['Keyboard yang mantap untuk kantoran', 'Keyboard gaming MSI mekanik', 'Mouse Genius biar lebih pinter', 'Mouse yang disukai kucing'],
        'source' => ['logitek.jpeg', 'msi.jpeg', 'genius.jpeg', 'jerry.jpeg'],
    ];
